...
// const SidebarItem = ({ item, level = 0, onLinkClick, token }) => {
...
// const AdminSidebar = ({ onLinkClick , token}) => {
//     return (
...
const sidebar = [
    ...
    },
    {
        name: 'User Management',
        Children: [{ name: 'User', link: '/sordar/user' }],
        roles: ['admin', 'developer'], // Only visible to these roles
    },
]
...
const AdminSidebar = ({ onLinkClick, role }) => {
    ...
    const filteredSidebar = filterItemsByRole(sidebar)
